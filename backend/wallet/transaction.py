...
class Transaction:
    """ 
    Document of an exchange in currency from a sender to a recipient.
    """
    ...
    def is_valid_transaction(transaction):
        ...
        if transaction.input['amount'] != output_total:
            raise Exception('Invalid transaction from invalid input amount')
        ...
        if not Wallet.verify(
            ...
            raise Exception('Invalid transaction from invalid signature')
